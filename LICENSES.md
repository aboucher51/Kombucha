...
say so explicitly rather than assuming it is permissive.

| What | Where | Licence | Licence text |
|---|---|---|---|
| GUT 9.7.1 (Godot Unit Testing) | `addons/gut/` | MIT | `addons/gut/LICENSE.md` |
